...
export const storeFile = [
  {
    ...
    description:
      'Quickly sign up to efficiently manage and securely store your files with Fusions Cloud’s user-friendly platform.',
    icon: 'User',
    color: '#9F57CB',
...
export const testimonials = [
  {
    ...
    post: 'Fusions Cloud has completely transformed our workflow with its user-friendly interface and efficiency. Highly recommended for anyone looking for a reliable file management solution.',
    date: new Date(),
  },
  {
    ...
    post: "Since we started using Fusions Cloud, our team's collaboration has significantly improved. It's a reliable, secure platform that has streamlined our document management processes.",
    date: new Date(),
  },
  {
    name: 'Justin Willson',
    ...
    post: "Fantastic tool with unbeatable features! Fusions Cloud's support team is always responsive and helpful, making it an excellent choice for our business needs.",
    date: new Date(),
  },
  {
    name: 'Justin Willson',
    ...
    post: 'Fusions Cloud made file management not only easy but also secure. Its features are perfectly tailored for growing businesses like ours, looking for scalable solutions.',
    date: new Date(),
  },
  {
    name: 'Jonathat Taylor',
    ...
    post: "A must-have service for any organization, Fusions Cloud's intuitive design and robust functionality make it indispensable for managing our critical data efficiently.",
    date: new Date(),
  },
  {
    name: 'Isabella Berger',
    ...
    post: 'We rely on Fusions Cloud daily for its excellent value and superb data protection system. Gradually has become an essential tool in our data management strategy.',
    date: new Date(),
  },
];
