...
export default function AuthenticationEmail(url: string) {
  return (
    <Html>
      ...
      <Preview>Sign in with this link </Preview>
        ...
        <Body className="bg-white">
          <Container className="mx-auto w-[560px] px-8 pt-14 pb-12 mt-8 border border-solid rounded-lg bg-steel-50/30 border-steel-100">
            <Section className="text-center">
              <Heading className="m-0 text-2xl font-medium">Fusions Cloud</Heading>
            </Section>
            ...
            <Section>
              ...
              <Text className="text-sm leading-loose text-steel-600">
                Welcome to FusionsCloud, To sign in, please click the button below.
              </Text>
            </Section>
          ...
          <Container className="text-center">
            <Text className="text-sm text-steel-400">
              © {format(new Date(), 'yyyy')} FusionsCloud, All Rights Reserved
            </Text>
          </Container>
        </Body>
      </Tailwind>
