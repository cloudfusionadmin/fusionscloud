...
// Removed video-player related imports

export default function Hero() {
  return (
    <Section
      id="hero"
      className="bg-[#141D25] [background-image:url('/assets/hero-bg-sm.webp')] md:[background-image:url('/assets/heroe-bg.webp')] bg-cover bg-no-repeat mb-[158px] md:mb-0 pt-20 3xl:pt-[6rem] lg:pb-5 3xl:pb-[177px] bg-full bg-top relative font-geist"
    >
        ...
        >
          <Box>
            <Box className="mb-7 lg:mb-12 3xl:mb-16">
              ...
              >
                Empower your workspace simplify your files with Fusions Cloud
              </Title>
              <Text
                as="p"
          ...
          {/* Removed IntroVideo component */}
          {/* Added Image component */}
          <Box className="image-container">
            <Image
              src="/assets/intro-poster.webp"
